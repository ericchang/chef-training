...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ericchang-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/eric-inc"
  #   chef.validation_client_name = "eric-inc-validator"
  #   chef.validation_key_path = ".chef/eric-inc-validator.pem"
  # end
end
